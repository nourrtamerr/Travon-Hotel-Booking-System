...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DraftReservationRoom", b =>
                {
                    b.Property<int>("DraftReservationsId")
                        .HasColumnType("int");

                    b.Property<int>("ReservedId")
                        .HasColumnType("int");

                    b.HasKey("DraftReservationsId", "ReservedId");
            ...
            modelBuilder.Entity("MVCBookingFinal_YARAB_.Models.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "1",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "c0755c82-43c0-421e-93ee-8a314568014c",
            ...
            modelBuilder.Entity("MVCBookingFinal_YARAB_.Models.DraftReservation", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CheckInDate = new DateTime(2025, 3, 7, 22, 18, 11, 175, DateTimeKind.Local).AddTicks(4274),
                            CheckOutDate = new DateTime(2025, 3, 12, 22, 18, 11, 175, DateTimeKind.Local).AddTicks(4289),
                            UserId = "1"
                        });
                });
            ...
            modelBuilder.Entity("MVCBookingFinal_YARAB_.Models.Payment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            PaymentDate = new DateTime(2025, 3, 7, 22, 18, 11, 176, DateTimeKind.Local).AddTicks(4778),
                            PaymentMethodId = 25,
            ...
            modelBuilder.Entity("MVCBookingFinal_YARAB_.Models.PromoCode", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Code = "ANMMM",
                            Discount = 20.0,
                            ExpiryDate = new DateTime(2025, 3, 12, 22, 18, 11, 176, DateTimeKind.Local).AddTicks(6823),
                            IsActive = true
                        });
                });
            ...
            modelBuilder.Entity("MVCBookingFinal_YARAB_.Models.Report", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Complaint = "bad food",
                            HotelId = 1,
                            ReviewDate = new DateTime(2025, 3, 7, 22, 18, 11, 176, DateTimeKind.Local).AddTicks(8855),
                            UserId = "1",
                            isDeleted = false
                        });
                });
            ...
            modelBuilder.Entity("MVCBookingFinal_YARAB_.Models.Reservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AmenityId = 1,
                            CheckInDate = new DateTime(2025, 3, 7, 22, 18, 11, 177, DateTimeKind.Local).AddTicks(1358),
                            CheckOutDate = new DateTime(2025, 3, 12, 22, 18, 11, 177, DateTimeKind.Local).AddTicks(1363),
                            mealPlanId = 1,
                            reservationStatus = 1
                        });
                });
            ...
            modelBuilder.Entity("MVCBookingFinal_YARAB_.Models.Review", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            HotelId = 1,
                            Rating = 5,
                            ReviewDate = new DateTime(2025, 3, 7, 22, 18, 11, 177, DateTimeKind.Local).AddTicks(5692),
                            UserId = "1",
                            isDeleted = false
                        });
                });
            ...
            modelBuilder.Entity("DraftReservationRoom", b =>
                {
                    b.HasOne("MVCBookingFinal_YARAB_.Models.DraftReservation", null)
                        .WithMany()
                        .HasForeignKey("DraftReservationsId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("MVCBookingFinal_YARAB_.Models.Room", null)
                        .WithMany()
