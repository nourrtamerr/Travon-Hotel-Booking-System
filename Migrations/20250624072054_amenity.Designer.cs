...
namespace MVCBookingFinal_YARAB_.Migrations
{
    ...
    [Migration("20250624072054_amenity")]
            ...
            modelBuilder.Entity("MVCBookingFinal_YARAB_.Models.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "1",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "fc281ddb-af57-4b56-9d5d-1a6e544e7d9c",
            ...
            modelBuilder.Entity("MVCBookingFinal_YARAB_.Models.DraftReservation", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CheckInDate = new DateTime(2025, 6, 24, 10, 20, 53, 548, DateTimeKind.Local).AddTicks(6077),
                            CheckOutDate = new DateTime(2025, 6, 29, 10, 20, 53, 548, DateTimeKind.Local).AddTicks(6116),
                            UserId = "1"
                        });
                });
            ...
            modelBuilder.Entity("MVCBookingFinal_YARAB_.Models.Payment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            PaymentDate = new DateTime(2025, 6, 24, 10, 20, 53, 549, DateTimeKind.Local).AddTicks(3772),
                            PaymentMethodId = 25,
            ...
            modelBuilder.Entity("MVCBookingFinal_YARAB_.Models.PromoCode", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Code = "ANMMM",
                            Discount = 20.0,
                            ExpiryDate = new DateTime(2025, 6, 29, 10, 20, 53, 549, DateTimeKind.Local).AddTicks(5476),
                            IsActive = true
                        });
                });
            ...
            modelBuilder.Entity("MVCBookingFinal_YARAB_.Models.Report", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Complaint = "bad food",
                            HotelId = 1,
                            ReviewDate = new DateTime(2025, 6, 24, 10, 20, 53, 549, DateTimeKind.Local).AddTicks(7157),
                            UserId = "1",
                            isDeleted = false
                        });
                });
            ...
            modelBuilder.Entity("MVCBookingFinal_YARAB_.Models.Reservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AmenityId = 1,
                            CheckInDate = new DateTime(2025, 6, 24, 10, 20, 53, 549, DateTimeKind.Local).AddTicks(8887),
                            CheckOutDate = new DateTime(2025, 6, 29, 10, 20, 53, 549, DateTimeKind.Local).AddTicks(8901),
                            mealPlanId = 1,
                            reservationStatus = 1
                        });
                });
            ...
            modelBuilder.Entity("MVCBookingFinal_YARAB_.Models.Review", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            HotelId = 1,
                            Rating = 5,
                            ReviewDate = new DateTime(2025, 6, 24, 10, 20, 53, 550, DateTimeKind.Local).AddTicks(2326),
                            UserId = "1",
                            isDeleted = false
                        });
                });
