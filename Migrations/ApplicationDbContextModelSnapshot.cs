...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MVCBookingFinal_YARAB_.Models.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "1",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "effed422-d3fe-4462-a884-304f87da9eeb",
            ...
            modelBuilder.Entity("MVCBookingFinal_YARAB_.Models.DraftReservation", b =>
                {
                    ...
                    b.ToTable("DraftReservations", (string)null);

                    b.HasData(
                        new
                        {
                            Id = 1,
                            CheckInDate = new DateTime(2025, 6, 24, 10, 25, 46, 725, DateTimeKind.Local).AddTicks(3038),
                            CheckOutDate = new DateTime(2025, 6, 29, 10, 25, 46, 725, DateTimeKind.Local).AddTicks(3074),
                            UserId = "1"
                        });
                });
            ...
            modelBuilder.Entity("MVCBookingFinal_YARAB_.Models.DraftReservationRoom", b =>
                {
                    ...
                    b.ToTable("DraftReservationRoom", (string)null);
                });
            ...
            modelBuilder.Entity("MVCBookingFinal_YARAB_.Models.HotelImage", b =>
                {
                    ...
                    b.ToTable("HotelsImages", (string)null);
            ...
            modelBuilder.Entity("MVCBookingFinal_YARAB_.Models.Payment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            PaymentDate = new DateTime(2025, 6, 24, 10, 25, 46, 726, DateTimeKind.Local).AddTicks(9050),
                            PaymentMethodId = 25,
            ...
            modelBuilder.Entity("MVCBookingFinal_YARAB_.Models.PromoCode", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Code = "ANMMM",
                            Discount = 20.0,
                            ExpiryDate = new DateTime(2025, 6, 29, 10, 25, 46, 727, DateTimeKind.Local).AddTicks(3085),
                            IsActive = true
                        });
                });
            ...
            modelBuilder.Entity("MVCBookingFinal_YARAB_.Models.Report", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Complaint = "bad food",
                            HotelId = 1,
                            ReviewDate = new DateTime(2025, 6, 24, 10, 25, 46, 727, DateTimeKind.Local).AddTicks(7015),
                            UserId = "1",
                            isDeleted = false
                        });
                });
            ...
            modelBuilder.Entity("MVCBookingFinal_YARAB_.Models.Reservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AmenityId = 1,
                            CheckInDate = new DateTime(2025, 6, 24, 10, 25, 46, 728, DateTimeKind.Local).AddTicks(1162),
                            CheckOutDate = new DateTime(2025, 6, 29, 10, 25, 46, 728, DateTimeKind.Local).AddTicks(1205),
                            mealPlanId = 1,
                            reservationStatus = 1
                        });
                });
            ...
            modelBuilder.Entity("MVCBookingFinal_YARAB_.Models.Review", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            HotelId = 1,
                            Rating = 5,
                            ReviewDate = new DateTime(2025, 6, 24, 10, 25, 46, 728, DateTimeKind.Local).AddTicks(7140),
                            UserId = "1",
                            isDeleted = false
                        });
                });
            ...
            modelBuilder.Entity("MVCBookingFinal_YARAB_.Models.RoomImage", b =>
                {
                    ...
                    b.ToTable("RoomsImages", (string)null);
            ...
            modelBuilder.Entity("MVCBookingFinal_YARAB_.Models.UsedPromoCodes", b =>
                {
                    ...
                    b.ToTable("UsedPromoCodes", (string)null);
            ...
            modelBuilder.Entity("MVCBookingFinal_YARAB_.ViewModels.ReviewViewModel", b =>
                {
                    b.Property<int?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ReviewViewModel", (string)null);
                });
            ...
            modelBuilder.Entity("MVCBookingFinal_YARAB_.Models.CardPaymentMethod", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CVV = "332",
                            CardNumber = "5151515",
                            ExpiryDate = new DateOnly(2028, 6, 24)
                        });
                });
