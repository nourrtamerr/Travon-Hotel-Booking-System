            ...
            modelBuilder.Entity("MVCBookingFinal_YARAB_.Models.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "1",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "bfdd88cb-8969-409d-bd27-997addcb2532",
            ...
            modelBuilder.Entity("MVCBookingFinal_YARAB_.Models.DraftReservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AmenityId = 1,
                            CheckInDate = new DateTime(2025, 3, 3, 2, 42, 36, 130, DateTimeKind.Local).AddTicks(8586),
                            CheckOutDate = new DateTime(2025, 3, 8, 2, 42, 36, 130, DateTimeKind.Local).AddTicks(8594),
                            UserId = "1",
                            mealPlanId = 1
                        });
                });
            ...
            modelBuilder.Entity("MVCBookingFinal_YARAB_.Models.Payment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            PaymentDate = new DateTime(2025, 3, 3, 2, 42, 36, 131, DateTimeKind.Local).AddTicks(6770),
                            PaymentMethodId = 25,
            ...
            modelBuilder.Entity("MVCBookingFinal_YARAB_.Models.PromoCode", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Code = "ANMMM",
                            Discount = 20.0,
                            ExpiryDate = new DateTime(2025, 3, 8, 2, 42, 36, 131, DateTimeKind.Local).AddTicks(8502),
                            IsActive = true
                        });
                });
            ...
            modelBuilder.Entity("MVCBookingFinal_YARAB_.Models.Report", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Complaint = "bad food",
                            HotelId = 1,
                            ReviewDate = new DateTime(2025, 3, 3, 2, 42, 36, 132, DateTimeKind.Local).AddTicks(291),
                            UserId = "1",
                            isDeleted = false
                        });
                });
            ...
            modelBuilder.Entity("MVCBookingFinal_YARAB_.Models.Reservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AmenityId = 1,
                            CheckInDate = new DateTime(2025, 3, 3, 2, 42, 36, 132, DateTimeKind.Local).AddTicks(2062),
                            CheckOutDate = new DateTime(2025, 3, 8, 2, 42, 36, 132, DateTimeKind.Local).AddTicks(2066),
                            mealPlanId = 1,
                            reservationStatus = 1
                        });
                });
            ...
            modelBuilder.Entity("MVCBookingFinal_YARAB_.Models.Review", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            HotelId = 1,
                            Rating = 5,
                            ReviewDate = new DateTime(2025, 3, 3, 2, 42, 36, 132, DateTimeKind.Local).AddTicks(5493),
                            UserId = "1",
                            isDeleted = false
                        });
                });
            ...
            modelBuilder.Entity("MVCBookingFinal_YARAB_.Models.CardPaymentMethod", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CVV = "332",
                            CardNumber = "5151515",
                            ExpiryDate = new DateOnly(2028, 3, 3)
                        });
                });
