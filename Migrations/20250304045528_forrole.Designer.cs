...
namespace MVCBookingFinal_YARAB_.Migrations
{
    ...
    [Migration("20250304045528_forrole")]
    partial class forrole
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MVCBookingFinal_YARAB_.Models.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "1",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "8d2b31f3-1dc1-40aa-9a0e-a6130f62dd21",
            ...
            modelBuilder.Entity("MVCBookingFinal_YARAB_.Models.DraftReservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AmenityId = 1,
                            CheckInDate = new DateTime(2025, 3, 4, 6, 55, 27, 440, DateTimeKind.Local).AddTicks(5519),
                            CheckOutDate = new DateTime(2025, 3, 9, 6, 55, 27, 440, DateTimeKind.Local).AddTicks(5524),
                            UserId = "1",
                            mealPlanId = 1
                        });
                });
            ...
            modelBuilder.Entity("MVCBookingFinal_YARAB_.Models.Payment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            PaymentDate = new DateTime(2025, 3, 4, 6, 55, 27, 441, DateTimeKind.Local).AddTicks(3289),
                            PaymentMethodId = 25,
            ...
            modelBuilder.Entity("MVCBookingFinal_YARAB_.Models.PromoCode", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Code = "ANMMM",
                            Discount = 20.0,
                            ExpiryDate = new DateTime(2025, 3, 9, 6, 55, 27, 441, DateTimeKind.Local).AddTicks(4833),
                            IsActive = true
                        });
                });
            ...
            modelBuilder.Entity("MVCBookingFinal_YARAB_.Models.Report", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Complaint = "bad food",
                            HotelId = 1,
                            ReviewDate = new DateTime(2025, 3, 4, 6, 55, 27, 441, DateTimeKind.Local).AddTicks(6532),
                            UserId = "1",
                            isDeleted = false
                        });
                });
            ...
            modelBuilder.Entity("MVCBookingFinal_YARAB_.Models.Reservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AmenityId = 1,
                            CheckInDate = new DateTime(2025, 3, 4, 6, 55, 27, 441, DateTimeKind.Local).AddTicks(8196),
                            CheckOutDate = new DateTime(2025, 3, 9, 6, 55, 27, 441, DateTimeKind.Local).AddTicks(8201),
                            mealPlanId = 1,
                            reservationStatus = 1
                        });
                });
            ...
            modelBuilder.Entity("MVCBookingFinal_YARAB_.Models.Review", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            HotelId = 1,
                            Rating = 5,
                            ReviewDate = new DateTime(2025, 3, 4, 6, 55, 27, 442, DateTimeKind.Local).AddTicks(1454),
                            UserId = "1",
                            isDeleted = false
                        });
                });
            ...
            modelBuilder.Entity("MVCBookingFinal_YARAB_.Models.CardPaymentMethod", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CVV = "332",
                            CardNumber = "5151515",
                            ExpiryDate = new DateOnly(2028, 3, 4)
                        });
                });
