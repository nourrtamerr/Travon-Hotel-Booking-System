...
namespace MVCBookingFinal_YARAB_.Migrations
{
    ...
    [Migration("20250304170737_GoogleMaps")]
            ...
            modelBuilder.Entity("MVCBookingFinal_YARAB_.Models.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "1",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "5cd4d423-2e79-4caa-8175-074c2732c788",
            ...
            modelBuilder.Entity("MVCBookingFinal_YARAB_.Models.DraftReservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AmenityId = 1,
                            CheckInDate = new DateTime(2025, 3, 4, 19, 7, 35, 223, DateTimeKind.Local).AddTicks(5280),
                            CheckOutDate = new DateTime(2025, 3, 9, 19, 7, 35, 223, DateTimeKind.Local).AddTicks(5287),
                            UserId = "1",
                            mealPlanId = 1
                        });
                });
            ...
            modelBuilder.Entity("MVCBookingFinal_YARAB_.Models.Payment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            PaymentDate = new DateTime(2025, 3, 4, 19, 7, 35, 224, DateTimeKind.Local).AddTicks(3480),
                            PaymentMethodId = 25,
            ...
            modelBuilder.Entity("MVCBookingFinal_YARAB_.Models.PromoCode", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Code = "ANMMM",
                            Discount = 20.0,
                            ExpiryDate = new DateTime(2025, 3, 9, 19, 7, 35, 224, DateTimeKind.Local).AddTicks(5207),
                            IsActive = true
                        });
                });
            ...
            modelBuilder.Entity("MVCBookingFinal_YARAB_.Models.Report", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Complaint = "bad food",
                            HotelId = 1,
                            ReviewDate = new DateTime(2025, 3, 4, 19, 7, 35, 224, DateTimeKind.Local).AddTicks(6950),
                            UserId = "1",
                            isDeleted = false
                        });
                });
            ...
            modelBuilder.Entity("MVCBookingFinal_YARAB_.Models.Reservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AmenityId = 1,
                            CheckInDate = new DateTime(2025, 3, 4, 19, 7, 35, 224, DateTimeKind.Local).AddTicks(8749),
                            CheckOutDate = new DateTime(2025, 3, 9, 19, 7, 35, 224, DateTimeKind.Local).AddTicks(8753),
                            mealPlanId = 1,
                            reservationStatus = 1
                        });
                });
            ...
            modelBuilder.Entity("MVCBookingFinal_YARAB_.Models.Review", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            HotelId = 1,
                            Rating = 5,
                            ReviewDate = new DateTime(2025, 3, 4, 19, 7, 35, 225, DateTimeKind.Local).AddTicks(2207),
                            UserId = "1",
                            isDeleted = false
                        });
                });
