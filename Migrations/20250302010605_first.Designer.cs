...
namespace MVCBookingFinal_YARAB_.Migrations
{
    ...
    [Migration("20250302010605_first")]
    partial class first
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MVCBookingFinal_YARAB_.Models.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "1",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "bc90d424-7439-4e3e-9ede-0131df874dfc",
            ...
            modelBuilder.Entity("MVCBookingFinal_YARAB_.Models.DraftReservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AmenityId = 1,
                            CheckInDate = new DateTime(2025, 3, 2, 3, 6, 4, 951, DateTimeKind.Local).AddTicks(2925),
                            CheckOutDate = new DateTime(2025, 3, 7, 3, 6, 4, 951, DateTimeKind.Local).AddTicks(2932),
                            UserId = "1",
                            mealPlanId = 1
                        });
                });
            ...
            modelBuilder.Entity("MVCBookingFinal_YARAB_.Models.Payment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            PaymentDate = new DateTime(2025, 3, 2, 3, 6, 4, 952, DateTimeKind.Local).AddTicks(1859),
                            PaymentMethodId = 1,
            ...
            modelBuilder.Entity("MVCBookingFinal_YARAB_.Models.PromoCode", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Code = "ANMMM",
                            Discount = 20.0,
                            ExpiryDate = new DateTime(2025, 3, 7, 3, 6, 4, 952, DateTimeKind.Local).AddTicks(3573),
                            IsActive = true
                        });
                });
            ...
            modelBuilder.Entity("MVCBookingFinal_YARAB_.Models.Report", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Complaint = "bad food",
                            HotelId = 1,
                            ReviewDate = new DateTime(2025, 3, 2, 3, 6, 4, 952, DateTimeKind.Local).AddTicks(5248),
                            UserId = "1",
                            isDeleted = false
                        });
                });
            ...
            modelBuilder.Entity("MVCBookingFinal_YARAB_.Models.Reservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AmenityId = 1,
                            CheckInDate = new DateTime(2025, 3, 2, 3, 6, 4, 952, DateTimeKind.Local).AddTicks(7050),
                            CheckOutDate = new DateTime(2025, 3, 7, 3, 6, 4, 952, DateTimeKind.Local).AddTicks(7055),
                            mealPlanId = 1,
                            reservationStatus = 1
                        });
                });
            ...
            modelBuilder.Entity("MVCBookingFinal_YARAB_.Models.Review", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            HotelId = 1,
                            Rating = 5,
                            ReviewDate = new DateTime(2025, 3, 2, 3, 6, 4, 953, DateTimeKind.Local).AddTicks(518),
                            UserId = "1",
                            isDeleted = false
                        });
                });
            ...
            modelBuilder.Entity("MVCBookingFinal_YARAB_.Models.CardPaymentMethod", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CVV = "332",
                            CardNumber = "5151515",
                            ExpiryDate = new DateOnly(2028, 3, 2)
                        });
                });
